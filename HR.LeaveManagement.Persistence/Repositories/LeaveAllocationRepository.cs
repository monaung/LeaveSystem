...
namespace HR.LeaveManagement.Persistence.Repositories
{
    public class LeaveAllocationRepository : GenericRepository<LeaveAllocation>, ILeaveAllocationRepository
    {
        ...
        {
            var leaveAllocation = await _context.LeaveAllocations.Include(q => q.LeaveType).ToListAsync();
        ...
        {
            var leaveAllocation = await _context.LeaveAllocations.Where(x=> x.EmployeeId == userId).Include(q => q.LeaveType).ToListAsync();
            return leaveAllocation;
        }
